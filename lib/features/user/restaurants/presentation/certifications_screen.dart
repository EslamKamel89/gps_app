          ...
          items.isEmpty
              ...
              : ListView.separated(
                ...
                itemBuilder: (context, i) {
                  final c = items[i];
                  final delay = (70 * i).ms;
                  return _CertificationCard(cert: c)
                      .animate(delay: delay)
...
class _CertificationCard extends StatelessWidget {
  ...
  RestaurantFile? get _firstFile =>
      (cert.file != null && cert.file!.isNotEmpty) ? cert.file!.first : null;
  ...
  Widget build(BuildContext context) {
    ...
    final hasValidUrl = _isValidHttpUrl(firstUrl);
