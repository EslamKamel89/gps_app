...
import 'package:gps_app/features/about/presentation/about_screen.dart';
...
import 'package:gps_app/features/image_scan/presentation/scan_image_screen.dart';
  ...
  Route? onGenerateRoute(RouteSettings routeSettings) {
    ...
    switch (routeName) {
      ...
      case AppRoutesNames.authRequiredScreen:
        return CustomPageRoute(
          builder:
              (context) => AuthRequiredScreen(
                currentTab: (args as Map<String, dynamic>)['currentTab'],
              ),
          settings: routeSettings,
        );
